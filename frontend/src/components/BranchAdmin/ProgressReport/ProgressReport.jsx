...
//       console.log("working days is",workingDaysData)
...
//                       <div key={exam._id} className="p-4 mb-4 rounded-lg bg-gray-50">
//                         <div className="flex items-center justify-between mb-2">
//                           <h4 className="text-lg font-semibold">{exam.examName}</h4>
//                           <button
...
//                           <td className="px-4 py-2 text-center border">{month.workingDays}</td>
//                           <td className="px-4 py-2 text-center border">{month.daysPresent}</td>
//                           <td className="px-4 py-2 text-center border">{month.absentCount}</td>
