...
// //           console.log("creatett curracad res:",res)
// //           console.log("current academic year:",res.data[0].year)
...
// //                 return startB - startA || endB - endA; // Sort by start year, then by end year
// //               })[0]; // Get the first (latest) academic year
          
// //             console.log("Latest Academic Year:", latestAcademicYear.year); // Output: "2024-2025"
// //             console.log("Latest Academic Year:", latestAcademicYear._id); // id
...
// //             console.log("whiole data is", result);
            
// //           } else {
// //             toast.error(result.message || "Failed to fetch wholedata");
// //           }
// //         } catch (error) {
// //           toast.error("Error fetching wholedata");
// //         }
// //     }
// //     useEffect(()=>{
...
//         const selectClass = wholeData.find(cls => cls._id === classId);
//         if (!selectClass) {
//           toast.error("Class not found");
//           return;
//         }
        
//         const response = await fetch(Allapi.getSectionsByClass.url(selectClass.name, acid), {
...
//   const addSchedule = () => {
//     if (!selectedSubject || !totalMarks || !passMarks || !date) {
...
//             disabled
//             className="w-full p-3 bg-gray-100 border rounded focus:ring-2 focus:ring-indigo-500"
//           />
//         </div>
...
//                       Marks: {item.marks} | Pass Marks: {item.passMarks} | Date: {new Date(item.date).toLocaleDateString()}
//                     </p>
//                   </div>
