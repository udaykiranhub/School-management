...
//         initializeEmptyMarks(students, selectedExam?.subjects || []);
//       }
//     } catch (error) {
...
//   const initializeEmptyMarks = (studentList, subjects) => {
//     const initialMarks = {};
...
//         setStudents(result.data);
//         if (selectedExam) {
//           await fetchExistingMarks(selectedExam._id, classId, sectionId);
//         }
//       }
//     } catch (error) {
//       console.warn("Error in fetchStudents:", error);
...
//           const api = existingMarksFound ? 
//             { 
//               url: Allapi.updateMarks.url(submission._id,branchdet._id),
//               method: Allapi.updateMarks.method 
//             } : 
//             { 
//               url: Allapi.addMarks.url(branchdet._id),
//               method: Allapi.addMarks.method 
//             };
...
//       if (successful > 0) {
//         toast.success(`Successfully ${existingMarksFound ? 'updated' : 'added'} marks for ${successful} students.`);
//         // Refresh the marks data
//         await fetchExistingMarks(selectedExam._id, selectedClass, selectedSection);
//       }

//       if (errors > 0) {
//         toast.error(`Failed to ${existingMarksFound ? 'update' : 'add'} marks for ${errors} students.`);
//       }
//     } catch (error) {
//       toast.error(`An unexpected error occurred while ${existingMarksFound ? 'updating' : 'submitting'} marks.`);
//     }
//   };
...
//           className="w-full px-6 py-3 mt-6 text-white transition-colors bg-blue-500 rounded hover:bg-blue-600"
//         >
//           {existingMarksFound ? 'Update Marks' : 'Submit Marks'}
//         </button>
//           </div>
//         )}
