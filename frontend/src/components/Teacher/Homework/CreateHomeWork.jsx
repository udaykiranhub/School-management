...
//         console.log("current teacher assignment: ",currentTeacherAssignment)
//       }
//     } catch (error) {
...
//   //   // TODO: Implement the API call to submit homework
...
//         fileLink: formData.file ? formData.file.name : null, // Send the file name if it exists
//       };
  
//       // Add branch ID from the decoded token
//       const decoded = jwtDecode(token);
//       formDataToSend.branchId = decoded.teacherData.branchId;
...
//         },
//         body: JSON.stringify(formDataToSend), // Convert the object to JSON
//       });
